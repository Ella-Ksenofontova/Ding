...
class FriendsLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users (friendship)"
...
class FollowLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users (follwowers and followed)"
...
class ChatAdminLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users and Chats (admins of chats)"
...
class GroupAdminLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users and Groups (admins of groups)"
...
class UserGroupLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users and Groups (members of groups)"
...
class UserChatLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users and Chats (participants of chats)"
...
class UserPostLink(SQLModel, table=True):
    "This class represents auxilary table for many-to-many relationship between Users and Posts (users who liked posts)"
